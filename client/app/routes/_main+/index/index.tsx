        ...
        <div className="flex flex-wrap justify-center gap-8 mt-16">
          ...
          <div className="flex-[0_0_calc(50%-1rem)] max-w-[715px] bg-[#faf7f2] rounded-lg overflow-hidden">
            ...
            <div className="px-6 pb-[60px] pt-8">
              <h3 className="text-[20px] leading-[32px] font-bold text-[#696969] mb-4">Cơ sở vật chất</h3>
              <Link
                to="/co-so-vat-chat"
          ...
          <div className="flex-[0_0_calc(50%-1rem)] max-w-[715px] bg-[#faf7f2] rounded-lg overflow-hidden">
            ...
            />
            <div className="px-6 pb-[60px] pt-8">
              <h3 className="text-[20px] leading-[32px] font-bold text-[#696969] mb-4">Chương trình học</h3>
              <Link
                to="/chuong-trinh-hoc"
                className="inline-flex items-center px-6 py-3 bg-[#9ab987] text-white rounded-full hover:bg-[#839e71] transition-colors"
              >
          ...
          <div className="flex-[0_0_calc(50%-1rem)] max-w-[715px] bg-[#faf7f2] rounded-lg overflow-hidden">
            ...
            />
            <div className="px-6 pb-[60px] pt-8">
              <h3 className="text-[20px] leading-[32px] font-bold text-[#696969] mb-4">Đội ngũ giáo viên</h3>
              <Link
          ...
          <div className="flex-[0_0_calc(50%-1rem)] max-w-[715px] bg-[#faf7f2] rounded-lg overflow-hidden">
            ...
            />
            <div className="px-6 pb-[60px] pt-8">
              <h3 className="text-[20px] leading-[32px] font-bold text-[#696969] mb-4">Bữa ăn</h3>
              <Link
          ...
          <div className="flex-[0_0_calc(50%-1rem)] max-w-[715px] bg-[#faf7f2] rounded-lg overflow-hidden">
            ...
            />
            <div className="px-6 pb-[60px] pt-8">
              <h3 className="text-[20px] leading-[32px] font-bold text-[#696969] mb-4">Hệ thống ILO</h3>
              <Link
                to="/he-thong-ilo"
                className="inline-flex items-center px-6 py-3 bg-[#9ab987] text-white rounded-full hover:bg-[#839e71] transition-colors"
              >
          ...
          <div className="flex-[0_0_calc(50%-1rem)] max-w-[715px] bg-[#faf7f2] rounded-lg overflow-hidden">
            ...
            />
            <div className="px-6 pb-[60px] pt-8">
              <h3 className="text-[20px] leading-[32px] font-bold text-[#696969] mb-4">Chương trình</h3>
              <Link
            ...
            <form className="space-y-6">
              ...
              <div className="flex items-start gap-2">
                <input
                  ...
                  className="mt-1.5"
                />
                <label htmlFor="consent" className="text-[#696969] text-[16px] leading-[24px]">
                  Bằng việc đăng ký thông tin, bạn đồng ý cho phép ILO liên lạc thông qua các hình thức: cuộc gọi, tin nhắn, email nhằm mục đích tư vấn các chương trình mầm non & nghiên cứu thị trường. Xem chi tiết về các điều khoản bảo vệ dữ liệu cá nhân mà ILO sẽ thực hiện cho khách hàng tại <a href="#" className="text-blue-600 hover:underline">đây</a>.
                </label>
              </div>
